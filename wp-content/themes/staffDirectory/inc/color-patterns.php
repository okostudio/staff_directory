<?php
/**
 * Staff Directory: Color Patterns
 *
 * @package WordPress
 ...
 */
function staffDirectory_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Staff Directory default saturation level.
	 *
	 * @since Staff Directory 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'staffDirectory_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.staffDirectory-front-page) .entry-title,
...
.colors-custom .staffDirectory-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.staffDirectory-front-page .panel-content .recent-posts article,
...
.colors-custom.staffDirectory-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Staff Directory custom colors CSS.
	 *
	 * @since Staff Directory 1.0
	 *
	 ...
	 */
	return apply_filters( 'staffDirectory_custom_colors_css', $css, $hue, $saturation );
}
